...
import numpy as np
import torch
from libs.camera_picture_viewer import Camera_picture_viewer
from libs.correction_matrix_producer import Correction_matrix_producer
from libs.image_loader import Image_loader
from libs.reconstructor import Reconstructor
from libs.tomograpic_viewer import Tomograpic_viewer
...
def run_main():
    cam_pic_front, def_cam_pic_front = Image_loader(
        path_pic_front,
        color_channel,
        None,
        None,
    ...
    cam_pic_top, def_cam_pic_top = Image_loader(
        path_pic_top,
        color_channel,
        None,
        None,
    ...
    cam_pic_120, def_cam_pic_120 = Image_loader(
        path_pic_120,
        color_channel,
        None,
        None,
    ...
    cam_pic_240, def_cam_pic_240 = Image_loader(
        path_pic_240,
        color_channel,
        None,
        None,
